...
# Περιγραφή #
 ...
 καθώς και την κατανομή τους σε αυτά με βάση συγκεκριμένα κριτήρια και λαμβάνοντας υπόψη τις προτιμήσεις τους. Ο υποψήφιος μαθητής ή ο κηδεμόνας του σε περίπτωση ανηλίκου θα πιστοποιείται μέσω TAXIS και στη συνεχεια
 θα έχει ποσβαση στην υπηρεσία για υποβολή της αίτησης. Στο τέλος της κατανομής  διευθυντής του κάθε σχολείου θα ενημερώνεται για τους μαθητές που θα φοιτήσουν στο σχολείο του.
