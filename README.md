...
# Περιγραφή #
 ...
 Ο υποψήφιος μαθητής ή ο κηδεμόνας του, σε περίπτωση ανηλίκου θα πιστοποιείται μέσω TAXIS και στη συνέχεια θα έχει πρόσβαση στην υπηρεσία για υποβολή της αίτησης. Στο τέλος της κατανομής  διευθυντής του κάθε σχολείου αφού πιστοποιείται μέσω sch.gr ,θα ενημερώνεται για τους μαθητές που θα φοιτήσουν στο σχολείο του.
